class AdminMisaProductCategory_Index extends AdminMisaProductCategory {
    constructor(...args) {
        super(...args);
    }
    ReRegister() {
    ...
    GenerateXMLRewriteUrl() {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "GenerateXMLRewriteUrl",
    ...
    UpdateRewriteProductUrl() {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdateRewriteProductUrl",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
                    ...
                    success: function (response) {
                        ...
                        //$("#txtHtml").val(response.response.data);
                        //$("#" + _this.ModalDataID).modal("show");
                    },
                    failure: function (response) {
                    }
        ...
        }, "Bạn có muốn cập nhật lại đường dẫn cho website ?");
    ...
    RestartWebsite() {
        ...
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "RestartWebsite",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
        ...
        }, "Bạn có muốn Restart lại website ?");
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.response.isError) {
                    ...
                    //location.href = "/PostsCategory/Index";
