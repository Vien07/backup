class AdminEmailMailBox_Index {
    constructor(model) {
        ...
        this.Controller = SteamSystem.VirtualFolder + "/EmailMailBox/"
    }
    ReRegister() {
        InitDragDropTable()
    }
    ...
    ReSend(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (!data.response.isError) {
                    _this._commonAdmin.ToastifyAlert(data.response.message, '')
