...
{
    public class WebsiteKeys: BaseEntity
    {
    ...
    public class WebsiteKeysValidator : AbstractValidator<WebsiteKeys>
    {
        public WebsiteKeysValidator()
        {
            //RuleFor(x => x.Title).NotEmpty().WithMessage(nameof(WebsiteKeys.Title) + " - " + ErrorCode.NotEmpty);
