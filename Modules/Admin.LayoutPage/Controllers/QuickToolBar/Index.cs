...
{
    #region Define
    public class QuickToolBarModel
    {
        public PageTitleModel PageTitle = new PageTitleModel("QuickToolBar", "Danh sách", "fas fa-layer-group", "/QuickToolBar");




        public IPagedList<Database.QuickToolBar> List;
        public Dictionary<string,string> Configs;
        public Database.QuickToolBar Detail;
    ...
    public partial class QuickToolBarController
    {
        ...
        public IActionResult Index()
        {
            ...
            _pageModel.Detail = new Database.QuickToolBar();
        ...
        {
            _pageModel.List = _srv.GetList(search).Data;
            string list = _viewRender.RenderPartialViewToString(QuickToolBarConstants.StaticPath.PartialView.Index_Table, _pageModel.List);
        ...
        public JsonResult Delete(List<int> ids)
        {
            ...
            var listData = _viewRender.RenderPartialViewToString(QuickToolBarConstants.StaticPath.PartialView.Index_Table, _srv.GetList(search).Data);
        ...
        {
            _pageModel.Search = new ParamSearch();
            var res = _repQuickToolBar.Enable(ids, isEnable,CreateUser);
            var listData = _viewRender.RenderPartialViewToString(QuickToolBarConstants.StaticPath.PartialView.Index_Table, _srv.GetList(_pageModel.Search).Data);
        ...
        public JsonResult Move(int fromId, int toId)
        {
            ...
            var res = _repQuickToolBar.Move(fromId, toId);
            var listData = _viewRender.RenderPartialViewToString(QuickToolBarConstants.StaticPath.PartialView.Index_Table, _srv.GetList(_pageModel.Search).Data);
            return new JsonResult(new { response = res, listData = listData });
        ...
        public JsonResult EnableUpdateOrder(ParamSearch search)
        {
            ...
            var res = _repQuickToolBar.EnableUpdateOrder();
            var listData = _viewRender.RenderPartialViewToString(QuickToolBarConstants.StaticPath.PartialView.Index_Table, _srv.GetList(search).Data);
            return new JsonResult(new { response = res, listData = listData });
        ...
        public JsonResult UpdateOrder(int id, double order)
        {
            ...
            var res = _repQuickToolBar.UpdateOrder(id, order);
