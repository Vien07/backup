class AdminFooterPage_Index {
    ...
    GenerateFooterPageHtml(pid) {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "GenerateFooterHtml",
    ...
    UpdateFooterPageHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdateFooterHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
        ...
        },"Bạn có muốn cập nhật footer ?");


    }
    UpdatePreviewFooterPageHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdatePreviewFooterHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
                    ...
                    success: function (response) {
                        console.log(response)
                        if (!response.responseObj.isError) {
                            $("#btnUpdateFooterPageHtml").attr("onclick", `_action_FooterPage.UpdateFooterPageHtml(${pid})`);
    ...
    RevertFooterPageHtml() {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "RevertFooterHtml",
            beforeSend: function (xhr) {
                xhr.setRequestHeader("XSRF-TOKEN",
                    $('input:hidden[name="__RequestVerificationToken"]').val());
            },
