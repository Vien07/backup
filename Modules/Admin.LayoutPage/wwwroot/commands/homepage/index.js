class AdminHomePage_Index {
    ...
    GenerateHomePageHtml(pid) {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "GenerateHomePageHtml",
    ...
    UpdateHomePageHtml() {
        ...
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdateHomePageHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
        ...
        }, "Bạn có muốn cập nhật trang chủ ?");


    }
    UpdatePreviewHomePageHtml() {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdatePreviewHomePageHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
                    ...
                    success: function (response) {
                        ...
                        console.log(response)
                        if (!response.responseObj.isError) {
                            $("#btnUpdateHomePageHtml").attr("onclick", `_action.UpdateHomePageHtml()`);
        ...
        }, "Bạn có muốn cập nhật bản xem trước của trang chủ ?");
    ...
    RevertHomePageHtml() {
        ...
        $.ajax({
            type: "GET",
            url: _this.Controller + "RevertHomePageHtml",
            beforeSend: function (xhr) {
                xhr.setRequestHeader("XSRF-TOKEN",
                    $('input:hidden[name="__RequestVerificationToken"]').val());
            },
