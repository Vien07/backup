class AdminSlider_Index {
    constructor(model) {
        ...
        this.Controller = SteamSystem.VirtualFolder + "/Slider/"
    }


    GenerateSliderHtml(pid) {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "GenerateSliderHtml",
    ...
    UpdateSliderHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdateSliderHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
        ...
        }, "Bạn có muốn cập nhật Slider ?");


    }
    UpdatePreviewSliderHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdatePreviewSliderHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
                    ...
                    success: function (response) {
                        ...
                        if (!response.responseObj.isError) {
                            $("#btnUpdateSliderHtml").attr("onclick", `_action.UpdateSliderHtml(${pid})`);
    ...
    RevertSliderHtml() {
        ...
        $.ajax({
            type: "GET",
            url: _this.Controller + "RevertSliderHtml",
            beforeSend: function (xhr) {
                xhr.setRequestHeader("XSRF-TOKEN",
                    $('input:hidden[name="__RequestVerificationToken"]').val());
            },
