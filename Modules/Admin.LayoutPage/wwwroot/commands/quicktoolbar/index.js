class AdminQuickToolBar_Index {
    ...
    GenerateQuickToolBarHtml(pid) {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "GenerateQuickToolBarHtml",
    ...
    UpdateQuickToolBarHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdateQuickToolBarHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
        ...
        }, "Bạn có muốn cập nhật QuickToolBar ?");


    }
    UpdatePreviewQuickToolBarHtml(pid) {
        let _this = this;
        _commonAdmin.AlertWarning(function (confirmed) {
            if (confirmed) {
                $.ajax({
                    type: "GET",
                    url: _this.Controller + "UpdatePreviewQuickToolBarHtml",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
                    },
                    ...
                    success: function (response) {
                        ...
                        if (!response.responseObj.isError) {
                            $("#btnUpdateQuickToolBarHtml").attr("onclick", `_action.UpdateQuickToolBarHtml(${pid})`);
    ...
    RevertQuickToolBarHtml() {
        let _this = this;

        $.ajax({
            type: "GET",
            url: _this.Controller + "RevertQuickToolBarHtml",
            beforeSend: function (xhr) {
                xhr.setRequestHeader("XSRF-TOKEN",
                    $('input:hidden[name="__RequestVerificationToken"]').val());
            },
