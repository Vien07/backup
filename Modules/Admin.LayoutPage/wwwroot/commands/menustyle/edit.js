class AdminMenuStyle_Edit {
    constructor(model) {
        ...
        this.Controller = SteamSystem.VirtualFolder + "/MenuStyle/";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (!data.response.isError) {
                        ...
                        $("#MenuStylePid").val(data.response.data.pid)
    ...
    SaveChild(formId) {
        ...
        if (_this.Validate(formId)) {
            //var formdata = new FormData($("#" + _this.fromUploadID)[0]);
            var formdata = new FormData($("#" + formId)[0]);
            formdata.append("MenuStylePid", $("#MenuStylePid").val());
            $.ajax({
                type: "POST",
