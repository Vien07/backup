...
{
    public class LogAdminActivity : BaseDatabaseModel
    {
    ...
    public class LogAdminActivityValidator : AbstractValidator<LogAdminActivity>
    {
        public LogAdminActivityValidator()
        {
