...
namespace Admin.Course.CMS.Pages
{
    public class CourseModel : PageModel
    {
        ...
        public IPagedList<Database.Course> List;
        public Database.Course ModelCourse;
        ...
        public CourseModel(ICourseRepository rep, IViewRendererHelper viewRender, ILoggerHelper logger)
        {
        ...
        {
            ModelCourse = new Database.Course();
        ...
        public JsonResult OnPostConfig(CourseConfigDto config)
        {
