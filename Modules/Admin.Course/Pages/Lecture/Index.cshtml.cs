...
namespace Admin.Course.CMS.Pages
{
    public class LectureModel : PageModel
    {
        ...
        public IPagedList<Database.Lecture> List;
        public Database.Lecture ModelLecture;
        ...
        public LectureModel(ILectureRepository rep, IViewRendererHelper viewRender, ILoggerHelper logger)
        {
        ...
        {
            ModelLecture = new Database.Lecture();
        ...
        public JsonResult OnPostConfig(LectureConfigDto config)
        {
