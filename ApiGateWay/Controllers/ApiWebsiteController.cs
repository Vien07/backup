...
namespace ApiGateWay.ApiControllers
{
    [ApiController, Route("/api/[controller]")]
    public class PublicAPIController : Controller
    {
        //private readonly ILogger _logger;
        private readonly IApiWebsiteService _rep;

        public PublicAPIController(IApiWebsiteService rep)
        {
            _rep = rep;
        ...
        public ContentResult Sitemap()
        {
            try
            {
                string host = "http://ofd.vn";//Request.Scheme + "://" + Request.Host;
        ...
        //    {
        //        string host = Request.Scheme + "://" + Request.Host;
        //        List<SiteMapModel> listProducts = _rep.ProductsSitemap();
    ...
    public static class PublicAPIControllerHelper
    {
