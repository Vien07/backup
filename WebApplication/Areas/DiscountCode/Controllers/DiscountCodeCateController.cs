...
{
    [Area("DiscountCode")]
    public class DiscountCodeCateController : Controller
    {
        private string PageLimitAdmin = "";
        private int DefaultPageSize = ConstantStrings.DefaultPageSize;

        private readonly IDiscountCodeCateRepository _rep;
        private readonly ICommonServices _common;

        private readonly DBContext _dBContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public DiscountCodeCateController(DBContext dBContext, IHttpContextAccessor httpContextAccessor, IDiscountCodeCateRepository rep, ICommonServices common)
        {
            _common = common;
        ...
        [CustomAuthorization("DiscountCodeCate", "VIEW")]
        ...
        [CustomAuthorization("DiscountCodeCate", "ADD")]
        public JsonResult Insert(string stringObj, string stringMultiLangObj)
        {
            DiscountCodeCate objDetail = JsonConvert.DeserializeObject<DiscountCodeCate>(stringObj);
            List<MultiLang_DiscountCodeCate> objList = JsonConvert.DeserializeObject<List<MultiLang_DiscountCodeCate>>(stringMultiLangObj);
        ...
        [CustomAuthorization("DiscountCodeCate", "EDIT")]
        ...
        [CustomAuthorization("DiscountCodeCate", "DELETE")]
