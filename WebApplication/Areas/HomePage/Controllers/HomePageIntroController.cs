...
{
    [Area("HomePage")]
    public class HomePageIntroController : Controller
    {
        private string PageLimitAdmin = "";

        private readonly IHomePageIntroRepository _rep;
        ...
        public HomePageIntroController(IHomePageIntroRepository rep,
        ...
        public JsonResult Insert(string stringObj, string stringMultiLangObj, IFormFile PicThumb, IFormFile BackgroundImage)
        {
            ...
            return Json(new { error = _rep.Insert(objDetail, objList, PicThumb, BackgroundImage), list = _rep.LoadData(search) });
        }
        [CustomAuthorization("HomePage", "VIEW")]
        ...
        public JsonResult Update(string stringObj, string stringMultiLangObj, IFormFile PicThumb, IFormFile BackgroundImage)
        {
            Models.HomePage objDetail = JsonConvert.DeserializeObject<Models.HomePage>(stringObj);
            List<MultiLang_HomePage> objList = JsonConvert.DeserializeObject<List<MultiLang_HomePage>>(stringMultiLangObj);
            ...
            return Json(new { error = _rep.Update(objDetail, objList, PicThumb, BackgroundImage), list = _rep.LoadData(search) });
        }
