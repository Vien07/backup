...
{
    [Area("Gallery")]
    public class GalleryCateController : Controller
    {
        private string PageLimitAdmin = "";
        private int DefaultPageSize = ConstantStrings.DefaultPageSize;

        private readonly IGalleryCateRepository _rep;
        private readonly ICommonServices _common;

        private readonly DBContext _dBContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public GalleryCateController(DBContext dBContext, IHttpContextAccessor httpContextAccessor, IGalleryCateRepository rep, ICommonServices common)
        {
            _common = common;
        ...
        [CustomAuthorization("GalleryCate", "VIEW")]
        ...
        [CustomAuthorization("GalleryCate", "ADD")]
        public JsonResult Insert(string stringObj, string stringMultiLangObj)
        {
            GalleryCate objDetail = JsonConvert.DeserializeObject<GalleryCate>(stringObj);
            List<MultiLang_GalleryCate> objList = JsonConvert.DeserializeObject<List<MultiLang_GalleryCate>>(stringMultiLangObj);
        ...
        [CustomAuthorization("GalleryCate", "EDIT")]
        ...
        [CustomAuthorization("GalleryCate", "DELETE")]
