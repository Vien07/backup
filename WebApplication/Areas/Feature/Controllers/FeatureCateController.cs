...
{
    [Area("Feature")]
    public class FeatureCateController : Controller
    {
        private string PageLimitAdmin = "";
        private int DefaultPageSize = ConstantStrings.DefaultPageSize;

        private readonly IFeatureCateRepository _rep;
        private readonly ICommonServices _common;

        private readonly DBContext _dBContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public FeatureCateController(DBContext dBContext, IHttpContextAccessor httpContextAccessor, IFeatureCateRepository rep, ICommonServices common)
        {
            _common = common;
        ...
        [CustomAuthorization("FeatureCate", "VIEW")]
        ...
        [CustomAuthorization("FeatureCate", "ADD")]
        public JsonResult Insert(string stringObj, string stringMultiLangObj)
        {
            FeatureCate objDetail = JsonConvert.DeserializeObject<FeatureCate>(stringObj);
            List<MultiLang_FeatureCate> objList = JsonConvert.DeserializeObject<List<MultiLang_FeatureCate>>(stringMultiLangObj);
        ...
        [CustomAuthorization("FeatureCate", "EDIT")]
        ...
        [CustomAuthorization("FeatureCate", "DELETE")]
