...
namespace CMS.Areas.Feature.Models
{
    public class FeatureDetail
    {
        ...
        public virtual ICollection<MultiLang_FeatureDetail> MultiLang_FeatureDetails { get; set; }
        public virtual ICollection<Images_Feature> Images_Featurees { get; set; }
        public virtual ICollection<FeatureCate_FeatureDetail> FeatureCate_FeatureDetails { get; set; }
        public virtual ICollection<EnquireList> EnquireLists { get; set; }
    }
}
