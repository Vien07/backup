...
{
    [Area("Promotion")]
    public class PromotionCateController : Controller
    {
        private string PageLimitAdmin = "";
        private int DefaultPageSize = ConstantStrings.DefaultPageSize;

        private readonly IPromotionCateRepository _rep;
        private readonly ICommonServices _common;

        private readonly DBContext _dBContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public PromotionCateController(DBContext dBContext, IHttpContextAccessor httpContextAccessor, IPromotionCateRepository rep, ICommonServices common)
        {
            _common = common;
        ...
        [CustomAuthorization("PromotionCate", "VIEW")]
        ...
        [CustomAuthorization("PromotionCate", "ADD")]
        public JsonResult Insert(string stringObj, string stringMultiLangObj)
        {
            PromotionCate objDetail = JsonConvert.DeserializeObject<PromotionCate>(stringObj);
            List<MultiLang_PromotionCate> objList = JsonConvert.DeserializeObject<List<MultiLang_PromotionCate>>(stringMultiLangObj);
        ...
        [CustomAuthorization("PromotionCate", "EDIT")]
        ...
        [CustomAuthorization("PromotionCate", "DELETE")]
