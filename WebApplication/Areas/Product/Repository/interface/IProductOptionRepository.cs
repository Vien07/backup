...
namespace CMS.Areas.Product
{
    public interface IProductOptionRepository
    {
        ...
        dynamic Insert(ProductOption ProductOption, List<MultiLang_ProductOption> multiLang_ProductOption, IFormFile PicThumb);
        dynamic Update(ProductOption ProductOption, List<MultiLang_ProductOption> multiLang_ProductOption, IFormFile PicThumb);
        bool Count(int code);
