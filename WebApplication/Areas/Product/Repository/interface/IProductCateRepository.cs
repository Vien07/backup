...
namespace CMS.Areas.Product
{
    public interface IProductCateRepository
    {
        ...
        dynamic Insert(ProductCate ProductCate, List<MultiLang_ProductCate> multiLang_ProductCate, IFormFile PicThumb);
        dynamic Update(ProductCate ProductCate, List<MultiLang_ProductCate> multiLang_ProductCate, IFormFile PicThumb);
        bool Count(int code);
