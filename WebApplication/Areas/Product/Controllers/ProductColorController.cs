...
namespace CMS.Areas.Product.Controllers
{
    ...
    public class ProductColorController : Controller
    {
        ...
        private readonly IProductColorRepository _rep;
        private readonly ICommonServices _common;

        private readonly DBContext _dBContext;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public ProductColorController(DBContext dBContext, IHttpContextAccessor httpContextAccessor, IProductColorRepository rep, ICommonServices common)
        {
            _common = common;
        ...
        [CustomAuthorization("ProductColor", "VIEW")]
        ...
        [CustomAuthorization("ProductColor", "ADD")]
        public JsonResult Insert(string stringObj, string stringMultiLangObj, IFormFile PicThumb)
        {
            ProductColor objDetail = JsonConvert.DeserializeObject<ProductColor>(stringObj);
            List<MultiLang_ProductColor> objList = JsonConvert.DeserializeObject<List<MultiLang_ProductColor>>(stringMultiLangObj);
        ...
        [CustomAuthorization("ProductColor", "EDIT")]
        ...
        [CustomAuthorization("ProductColor", "DELETE")]
