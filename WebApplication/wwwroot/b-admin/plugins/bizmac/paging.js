...
function PagingProduct(currentPage, lastpage) {
    ...
    for (let i = startPage; i <= endPage; i++) {
        li += `<li class="page-item ${i === currentPage ? "active" : ""} "><a class="page-link"  onclick=SearchProduct(${i})>${i}</a></li>`;
    }
    //console.log(currentBlock);
    var endBlock = parseInt(lastpage / block);
    var a = lastpage - endBlock * block;
    ...
    if (endBlock - 1 > currentBlock) {
        extendli = ` <li class="page-item"><a class="page-link" href="?page=1">...</a></li>
                     <li class="page-item"><a class="page-link" onclick=SearchProduct(${lastpage})>${lastpage}</a></li>`;
    }
    //console.log(lastpage);
    //console.log(block);
    //console.log(currentBlock);
    ...
    var htmlPaging = `
                       <nav class="pagination-wrap d-inline-block" aria-label="navigation">
                          <ul class="pagination ">
                              ...
                              <li  class="page-item">
                              <a class="page-link" ${perPage !== 0 ? "onclick=SearchProduct(" + perPage + ")" : ""}  aria-label="Previous">
                                                    <span aria-hidden="true">«</span>
                                                    <span class="sr-only">Previous</span>
                              </a>
                              </li>
                             ...
                             ${currentBlock < endBlock ? extendli : ""}
                              <li class="page-item">
                               <a ${nextPage <= lastpage ? "onclick=SearchProduct(" + nextPage + ")" : ""} class="page-link" aria-label="Next">
                                                    <span aria-hidden="true">»</span>
                                                    <span class="sr-only">Next</span>
                               </a>
                            </li>
...
function PagingCard(currentPage, lastpage) {
    ...
    for (let i = startPage; i <= endPage; i++) {
        li += `<li class="page-item ${i === currentPage ? "active" : ""}"><a class="page-link" onclick="SearchCard(${i}, ${orderPid})">${i}</a></li>`;
    ...
    if (endBlock - 1 > currentBlock) {
        extendli = ` <li class="page-item"><a class="page-link" href="?page=1">...</a></li>
                     <li class="page-item"><a class="page-link" onclick="SearchCard(${lastpage}, ${orderPid})">${lastpage}</a></li>`;
    }
    //console.log(lastpage);
    //console.log(block);
    //console.log(currentBlock);
    ...
    var htmlPaging = `
                       <nav class="pagination-wrap d-inline-block" aria-label="navigation">
                          <ul class="pagination ">
                              ...
                              <li  class="page-item">
                              <a class="page-link" ${perPage !== 0 ? "onclick=SearchCard(" + perPage + "," + orderPid + ")" : ""}  aria-label="Previous">
                                                    <span aria-hidden="true">«</span>
                                                    <span class="sr-only">Previous</span>
                              </a>
                              </li>
                             ...
                             ${currentBlock < endBlock ? extendli : ""}
                              <li class="page-item">
                               <a ${nextPage <= lastpage ? "onclick=SearchCard(" + nextPage + "," + orderPid + ")" : ""} class="page-link" aria-label="Next">
                                                    <span aria-hidden="true">»</span>
                                                    <span class="sr-only">Next</span>
                               </a>
                            </li>
