...
!function () {
    ...
    function R(t, e) {
        for (var n = Lt(t), r = 0, o = n.length; r < o; r++) {
            var i = n[r];
            e(t[i], i)
        }
    }
    ...
    }, Lt = Object.keys, Dt = Object.hasOwnProperty, Nt = function (t, n) {
        var r = {};
        return R(t, function (t, e) {
            e = n(t, e);
            r[e.k] = e.v
    ...
    var Ke, Xe, Je = Ie, Ze = function (t) {
    ...
    }, _n = !1, On = function (t, e) {
        return We(e.createElement(t), !0)
    }, Ln = On("HTML", window.document), Dn = {
        ...
        "SCRIPT" === e.tag() ? Vn = e.type() === Dn.START_ELEMENT_TYPE : Vn || (e.filterAttributes(function (t, e) {
            ...
            t.emit(e))
    }), Wt, X, Ut, K, On, rn, pn, Ln, g, Bt], pn = Pn(function (t, n) {
    ...
    var Pn = "x-tinymce/html"
        ...
        , kr = function (e) {
            ...
            n && e.on("PastePreProcess", function (t) {
                return n.call(e, Or(e), t)
            }),
                r && e.on("PastePostProcess", function (t) {
                    return r.call(e, Or(e), t)
                })
        }
        , Rr = function (t) {
            var e = {
            ...
            return Ct(e, t) ? "image/" + e[t] : "image/" + t
        };
    function Mr(r, t, n, o) {
        var i;
    ...
    var Uo, Ho = function (t) {
        ...
        Bt("ephox-salmon").resolve), Ln = t("upload-image-in-progress"), pn = "data-" + t("image-blob"), Pn = "data-" + t("image-upload"), $o = {
            uploadInProgress: l(Ln),
            blobId: l(pn),
            trackedImage: l(Pn)
        }, Vo = function (e) {
            var o = [];
    ...
    function ea(t) {
        ct(So(t), function (t) {
            var e;
            un(e = t) && !e.dom.hasChildNodes() && S(Ra, Ce(e)) && Oa(t)
        })
    }
    function na(e, t) {
    ...
    var ia, ua, aa = mu(on, "comment"), ca = function (t) {
    ...
    }, Pn = wo(), t = Pn.deviceType.isiOS() || Pn.deviceType.isAndroid(), Ln = l({
        isSupported: !1,
        cleanDocument: function () {
            return Vt.reject("not supported")
        }
    }), Ta = t ? Ln : function (t, e, n) {
        ...
        }, t = wo(), Ln = t.browser, Pn = (Ln.isEdge() && Ln.version.major < 16 || t.deviceType.isiOS(),
            La(Yu, ["doc", "win", "body", "getSelection", "setSelection"], {
                validate: et,
                label: "function"
            }),
            Bt("ephox-sloth").resolve), Na = l(Pn("bin")), Ln = wo(), Ca = l(Ln.browser.isIE() && Ln.browser.version.major <= 10), Pa = Ca() ? function (t, e, n) {
                e.control.block(),
        ...
        t(c, function (u, a) {
            return ut(e, function (t) {
                return e = c,
                    ...
                    o = void 0 !== o.value ? o.value : Oc.all(),
                    Oc.matches(i, r) && Oc.matches(o, n) && t(e);
                var e, n, r, o, i
            })
        })
    }
    ...
    }, Lc = ["mso-list"], Dc = "startElement", Nc = "endElement", Cc = "text", Pc = "comment", kc = oc("html", window.document), Pn = function (e) {
        return function (t) {
            !function (t, e) {
                var r = Ic({
                    styles: [],
                ...
                ct(e, function (n) {
                    ec(Qa, r.styles, n),
                        ...
                        ct(r.classes, function (e) {
                            ...
                            ct(t, function (t) {
                                Oc.matches(e.name, t) && Li(n, t)
                            })
                        })
                });
                t = Ro(t, "*");
                ct(t, function (t) {
                    ut(r.tags, p(Ka, t)) && Oa(t)
                })
            }(t, e)
        }
    }, Rc = function (t, e, n) {
    ...
    function bs(t) {
        t = vs("span", t),
            Oi(t, "ephox-limbo-transform"),
            Gu(t, "text-decoration", "underline")
    }
    var xs, Ts, ws, Es, Ss, As, Is, _s, Os, Ls, Ds, Ns = {
        inside: function () {
            return Ps
        },
        outside: function () {
    ...
    }, Cs = (xs = !1,
    {
            ...
            Is = fu(null),
        {
            ...
            tags: [{
                name: Oc.pattern(/^(p|h\d+)$/, Oc.caseInsensitive),
                mutate: function (t) {
            ...
            return Xr(t).bind(function (t) {
                return an(t) && 0 === Lu(t).trim().length ? Ys(t) : zs(t) ? G.some(t) : G.none()
            })
        }, Ln = function (e) {
            return function (t) {
                return Ce(t) === e
            ...
            tags: [{
                name: Oc.pattern(/^([OVWXP]|U[0-9]+|ST[0-9]+):/i, Oc.caseInsensitive)
            }]
        }), $s = Pn({
            attributes: [{
                name: Oc.exact("id", Oc.caseInsensitive),
                value: Oc.starts("docs-internal-guid", Oc.caseInsensitive)
            }]
        }), Vs = [sc([t])], Gs = Pn({
            attributes: [{
                name: Oc.pattern(/^v:/, Oc.caseInsensitive)
            }, {
                name: Oc.exact("href", Oc.caseInsensitive),
                value: Oc.contains("#_toc", Oc.caseInsensitive)
            }, {
                name: Oc.exact("href", Oc.caseInsensitive),
                value: Oc.contains("#_mso", Oc.caseInsensitive)
            }, {
                name: Oc.pattern(/^xmlns(:|$)/, Oc.caseInsensitive)
            }, {
                name: Oc.exact("type", Oc.caseInsensitive),
            ...
            tags: [{
                name: Oc.exact("script", Oc.caseInsensitive)
            }, {
                name: Oc.exact("link", Oc.caseInsensitive)
            }, {
                name: Oc.exact("style", Oc.caseInsensitive),
                condition: function (t) {
                    return 0 === Qu(t).length
                }
            }],
            attributes: [{
                name: Oc.starts("on", Oc.caseInsensitive)
            }, {
                name: Oc.exact('"', Oc.caseInsensitive)
            }, {
                name: Oc.exact("lang", Oc.caseInsensitive)
            }, {
                name: Oc.exact("language", Oc.caseInsensitive)
            }],
            styles: [{
                name: Oc.all(),
                value: Oc.pattern(/OLE_LINK/i, Oc.caseInsensitive)
            }]
        }), Xs = Pn({
            tags: [{
                name: Oc.exact("meta", Oc.caseInsensitive)
            }]
        }), Js = Pn({
            tags: [{
                name: Oc.exact("style", Oc.caseInsensitive)
            ...
            styles: [{
                name: Oc.not(Oc.pattern(/^(width|height|list-style-type)$/, Oc.caseInsensitive)),
                condition: function (t) {
                    return !Di(t, "ephox-limbo-transform")
                }
            }, {
                name: Oc.pattern(/^(width|height)$/, Oc.caseInsensitive),
                condition: function (t) {
            ...
            styles: [{
                name: Oc.exact("height", Oc.caseInsensitive),
                condition: Ln("td")
            }, {
                name: Oc.exact("width", Oc.caseInsensitive),
                condition: Ln("tr")
            }, {
                name: Oc.exact("height", Oc.caseInsensitive),
                condition: Ln("col")
            ...
            classes: [{
                name: Oc.not(Oc.exact("rtf-data-image", Oc.caseInsensitive))
            }]
        }), ef = Pn({
            styles: [{
                name: Oc.pattern(/^(mso-.*|tab-stops|tab-interval|language|text-underline|text-effect|text-line-through|font-color|horiz-align|list-image-[0-9]+|separator-image|table-border-color-(dark|light)|vert-align|vnd\..*)$/, Oc.caseInsensitive)
            }]
        }), nf = Pn({
            classes: [{
                name: Oc.pattern(/mso/i, Oc.caseInsensitive)
            }]
        }), rf = ac({
            tags: [{
                name: Oc.exact("img", Oc.caseInsensitive),
                condition: function (t) {
                    t = ln(t, "src");
            ...
            tags: [{
                name: Oc.exact("a", Oc.caseInsensitive),
                condition: Ws
            }]
        }), uf = Pn({
            attributes: [{
                name: Oc.exact("style", Oc.caseInsensitive),
                value: Oc.exact("", Oc.caseInsensitive)
            }]
        }), af = Pn({
            attributes: [{
                name: Oc.exact("class", Oc.caseInsensitive),
                value: Oc.exact("", Oc.caseInsensitive)
            }]
        }), cf = ac({
            tags: [{
                name: Oc.pattern(/^(font|em|strong|samp|acronym|cite|code|dfn|kbd|tt|b|i|u|s|sub|sup|ins|del|var|span)$/, Oc.caseInsensitive),
            ...
            tags: [{
                name: Oc.exact("p", Oc.caseInsensitive),
                condition: (Os = "li",
                    function (t) {
                        return Gr(t).exists(function (t) {
                            return Ce(t) === Os && 1 === So(t).length
                        })
                    }
                )
            }]
            ...
            tags: [{
                name: Oc.pattern(/ol|ul/, Oc.caseInsensitive),
                mutate: function (e) {
                    Gr(e).each(function (t) {
                        t = Ce(t);
            ...
            classes: [{
                name: Oc.exact("ephox-limbo-transform", Oc.caseInsensitive)
            }]
        }), mf = Pn({
            tags: [{
                name: Oc.exact("br", Oc.caseInsensitive),
                condition: pn("Apple-interchange-newline")
            }]
        }), pf = Pn({
            styles: [{
                name: Oc.pattern(/^-/, Oc.caseInsensitive)
            }, {
                name: Oc.all(),
                value: Oc.exact("initial", Oc.caseInsensitive)
            }, {
                name: Oc.exact("background-color", Oc.caseInsensitive),
                value: Oc.exact("transparent", Oc.caseInsensitive)
            }, {
                name: Oc.exact("font-style", Oc.caseInsensitive),
                value: Oc.exact("normal", Oc.caseInsensitive)
            }, {
                name: Oc.pattern(/font-variant.*/, Oc.caseInsensitive)
            }, {
                name: Oc.exact("letter-spacing", Oc.caseInsensitive)
            }, {
                name: Oc.exact("font-weight", Oc.caseInsensitive),
                value: Oc.pattern(/400|normal/, Oc.caseInsensitive)
            }, {
                name: Oc.exact("orphans", Oc.caseInsensitive)
            }, {
                name: Oc.exact("text-decoration", Oc.caseInsensitive),
                value: Oc.exact("none", Oc.caseInsensitive)
            }, {
                name: Oc.exact("text-size-adjust", Oc.caseInsensitive)
            }, {
                name: Oc.exact("text-indent", Oc.caseInsensitive),
                value: Oc.exact("0px", Oc.caseInsensitive)
            }, {
                name: Oc.exact("text-transform", Oc.caseInsensitive),
                value: Oc.exact("none", Oc.caseInsensitive)
            }, {
                name: Oc.exact("white-space", Oc.caseInsensitive),
                value: Oc.exact("normal", Oc.caseInsensitive)
            }, {
                name: Oc.exact("widows", Oc.caseInsensitive)
            }, {
                name: Oc.exact("word-spacing", Oc.caseInsensitive),
                value: Oc.exact("0px", Oc.caseInsensitive)
            }, {
                name: Oc.exact("text-align", Oc.caseInsensitive),
                value: Oc.pattern(/start|end/, Oc.caseInsensitive)
            }, {
                name: Oc.exact("font-weight", Oc.caseInsensitive),
                value: Oc.pattern(/700|bold/, Oc.caseInsensitive),
                condition: function (t) {
            ...
            cc({
                tags: [{
                    name: Oc.exact("span", Oc.caseInsensitive),
                    condition: pn("Apple-converted-space"),
                    mutate: function (t) {
                        "\xa0" === is(t) && (Ls(t) || Ds(t) ? Bu(t) : (tu(t, mn.fromText(" ")),
                            Oa(t)))
                    }
                }]
            }));
    ...
    var hf, yf = (hf = /^file:\/\/\/[^#]+(#[^#]+)$/,
        cc({
            ...
            attributes: [{
                name: Oc.exact("href", Oc.caseInsensitive),
                value: Oc.starts("file:///", Oc.caseInsensitive)
            }]
        }), xf = cc({
    ...
    function Tf(t, n, r) {
        return {
            name: Oc.exact(t, Oc.caseInsensitive),
            condition: function (t) {
                return je(t, n)
            },
            mutate: function (e) {
        ...
        return void 0 === t && (t = []),
            [Nf, Cf, (e = t,
                ...
                t = st(t, function (t) {
                    ...
                    return Ft({
                        name: Oc.exact(t.name, Oc.caseInsensitive)
                    }, t.transform)
                }),
                cc({
                    tags: t
    ...
    var Lf = Pn({
        ...
        , Nf = Pn({
            tags: [{
                name: Oc.exact("font", Oc.caseInsensitive),
                condition: function (t) {
                    function e(t) {
                        return t.replace(/[ \r\n\uFEFF]+/g, "")
                    }
        ...
        , Cf = cc({
            tags: [{
                name: Oc.exact("ol", Oc.caseInsensitive),
                mutate: pn
            }, {
                name: Oc.exact("ul", Oc.caseInsensitive),
                mutate: pn
            }]
        })
        , Pf = y
    ...
    var Tl, wl = Object.hasOwnProperty, El = Object.setPrototypeOf, Sl = Object.isFrozen, Al = Object.freeze, pn = Object.seal, Il = Object.create, Pn = "undefined" != typeof Reflect && Reflect, _l = (_l = Pn.apply) || function (t, e, n) {
        ...
        , Ol = (Ol = Pn.construct) || function (t, e) {
        ...
        , Ll = Ul(Array.prototype.forEach), Dl = Ul(Array.prototype.pop), Nl = Ul(Array.prototype.push), Cl = Ul(String.prototype.toLowerCase), Pl = Ul(String.prototype.match), kl = Ul(String.prototype.replace), Rl = Ul(String.prototype.indexOf), Ml = Ul(String.prototype.trim), Fl = Ul(RegExp.prototype.test), jl = (Tl = TypeError,
            function () {
    ...
    function cd(t, e) {
        Ld.addHook("uponSanitizeElement", function (t, e) {
            S(Dd, e.tagName) || Ct(e.allowedTags, e.tagName) || (e.allowedTags[e.tagName] = !0)
        }),
            Ld.addHook("uponSanitizeAttribute", function (t, e) {
        ...
        return Ld.removeHook("uponSanitizeElement"),
            Ld.removeHook("uponSanitizeAttribute"),
            n ? B(H(t, "<body>"), "</body>") : t
    }
    function sd(t) {
    ...
    var Ld = function e(t) {
        ...
        function L(t, e, n) {
            w[t] && Ll(w[t], function (t) {
                t.call(s, e, n, mt)
            })
        }
        function D(t) {
            var e;
            if (L("beforeSanitizeElements", t, null),
            ...
            if (L("uponSanitizeElement", t, {
                ...
                return S(t),
                    1;
            if (!O(t.firstElementChild) && (!O(t.content) || !O(t.content.firstElementChild)) && Fl(/<[!/\w]/g, t.innerHTML) && Fl(/<[!/\w]/g, t.textContent))
                return S(t),
                    1;
            if (W[n] && !$[n])
                return "noscript" !== n && "noembed" !== n || !Fl(/<\/no(script|embed)/i, t.innerHTML) ? (J && 3 === t.nodeType && (e = t.textContent,
                    ...
                    t.textContent !== e && (Nl(s.removed, {
                        ...
                        t.textContent = e)),
                    L("afterSanitizeElements", t, null),
                    0) : (S(t),
                        1);
        ...
        function P(t) {
            var e, n = _(t);
            for (L("beforeSanitizeShadowDOM", t, null); e = n.nextNode();)
                L("uponSanitizeShadowNode", e, null),
                    D(e) || (e.content instanceof f && P(e.content),
                        C(e));
            L("afterSanitizeShadowDOM", t, null)
        }
        ...
        return s.sanitize = function (t, e) {
            ...
            if ("string" != typeof (t = t || "\x3c!--\x3e") && !O(t)) {
    ...
    function Jd(c) {
        return function (t, a) {
            return ha(function (o) {
                ...
                function t(t, e) {
                    var n, r;
                    !1 === c.allowLocalImages ? u(t) : 0 === e.length ? (e = Od(n = t),
                        t = Qt(e, function (t) {
    ...
    function Lm(o) {
        return function (t, e) {
            return n = o,
                ...
                ha(function (t) {
                    var e = 0 < r.text.length ? Om(r.text, n) : pa();
                    hu(t, {
                        response: e,
                        bundle: fa({})
                    })
    ...
    var Rp = function (t) {
        return void 0 === t && (t = 4),
            Dp(Kd.text, Ip, [Tp(Lm(t)), Tp(Dm)], !0)
    }
        , Mp = function () {
            return Np(Kd.discard, Lp, [Tp(Pm)], !0)
        }
        , Fp = function (t, e, n, r, o) {
            ...
            var i, u = Ta(o, r.baseUrl, r.cacheSuffix), a = Ba(void 0 !== r.pasteBinAttrs ? r.pasteBinAttrs : {}), c = void 0 === r.sanitizer ? Nd(r.intraFlag.isMarked) : r.sanitizer, i = [function (t) {
                ...
                return Dp(Kd.plaintext, _p, [Tp(Lm(t)), Tp(Dm)], !0)
            }(r), Pp(u, e, r), (i = r,
                o = n,
                u = t,
                Dp(Kd.googledocs, Op, [Tp(km({
                    officeStyles: !1,
                    htmlStyles: !1
    ...
    var Gp = Object.freeze({
        ...
        , ng = function (i, t) {
            return $p(t).bind(function (t) {
                return r = t.url,
                    o = _t(i),
                    qp(r) && ut(o, function (t) {
                        return Rt(r, "." + t)
                    }) ? Vp(e = i, (n = t).html, function () {
