class AdminLocalizeManagement_Index {
    constructor(model) {
        ...
        this.Controller = SteamSystem.VirtualFolder + "/LocalizeManagement/";
    }
    ReRegister() {
        InitDragDropTable()
    }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.response.isError) {
                    ...
                    //location.href = "/LocalizeManagement/Index";
